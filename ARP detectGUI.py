...
class ArpSpoofGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("ARP Spoof Detection Tool")
    ...
    def create_widgets(self):
        ...
        self.heading_label = ttk.Label(header_frame, text="ARP Spoof Detection Tool", style="Header.TLabel")
    ...
    def show_about(self):
        about_text = (
            ...
            "Version 1.0\n\n"
            "This tool monitors your network for ARP spoofing attempts and alerts you in real time.\n"
            "For detailed help, please refer to the user manual or contact support.\n\n"
            "Designed by my manju maharjan"
        )
